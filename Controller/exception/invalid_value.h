...
public:
    ...
    invalid_value(const string& functionName, Error value, const string& specificMessage) : functionName(functionName), value(value), specificMessage(specificMessage) {}
